...
class DomNode extends DomNodeIterable
{
    ...
    public static function createFromStringWithFile($path, $contentType = "text/xml")
    {
        return self::createFromString(file_get_contents($path), $contentType);
    }
    ...
    public static function createFromString($str, $contentType = "text/xml")
    {
        ...
        if (!TextHelper::isEmpty($text)) {
            // todo throw new DomNodeException($text);
